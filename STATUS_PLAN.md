...
> **Примечание:** Новые идеи и фичи для будущих версий документируются в [FEATURES.md](./FEATURES.md). Этот файл содержит Roadmap (дорожную карту) и Backlog (бэклог) всех планируемых улучшений.
