// Векторные иконки для разделов sidebar
export const SidebarIcons = {
  ...
  properties: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 6L10 2L17 6V16C17 16.5304 16.7893 17.0391 16.4142 17.4142C16.0391 17.7893 15.5304 18 15 18H5C4.46957 18 3.96086 17.7893 3.58579 17.4142C3.21071 17.0391 3 16.5304 3 16V6Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <path d="M7 18V10H13V18" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>
  ),
  units: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8 5V3C8 2.73478 8.10536 2.48043 8.29289 2.29289C8.48043 2.10536 8.73478 2 9 2H11C11.2652 2 11.5196 2.10536 11.7071 2.29289C11.8946 2.48043 12 2.73478 12 3V5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>
  ),
  tenants: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M17 19V17C17 15.9391 16.5786 14.9217 15.8284 14.1716C15.0783 13.4214 14.0609 13 13 13H7C5.93913 13 4.92172 13.4214 4.17157 14.1716C3.42143 14.9217 3 15.9391 3 17V19" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <circle cx="10" cy="6" r="4" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>
  ),
  leases: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 4H16C16.5304 4 17.0391 4.21071 17.4142 4.58579C17.7893 4.96086 18 5.46957 18 6V16C18 16.5304 17.7893 17.0391 17.4142 17.4142C17.0391 17.7893 16.5304 18 16 18H4C3.46957 18 2.96086 17.7893 2.58579 17.4142C2.21071 17.0391 2 16.5304 2 16V6C2 5.46957 2.21071 4.96086 2.58579 4.58579C2.96086 4.21071 3.46957 4 4 4Z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <path d="M6 8H14" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M6 12H10" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  ),
  finance: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 2V18M10 2C8.89543 2 8 2.89543 8 4C8 5.10457 8.89543 6 10 6M10 2C11.1046 2 12 2.89543 12 4C12 5.10457 11.1046 6 10 6M10 14C8.89543 14 8 14.8954 8 16C8 17.1046 8.89543 18 10 18M10 14C11.1046 14 12 14.8954 12 16C12 17.1046 11.1046 18 10 18" stroke="currentColor" strokeWidth="1.5" fill="none"/>
  ...
  profile: (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M5 17C5 14.2386 7.23858 12 10 12C12.7614 12 15 14.2386 15 17" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>
  ),
  collapse: (
